{
  c1 = new TCanvas("c1", "Cs-137 10 second Data Gaussian Fit", 800, 600);

    h = new TH1F("h","Number of Decay Distribution(10 seconds)-Gaussian Fit",12,80,140);

    fgaus = new TF1("fgaus","gaus");
    fgaus->SetParameters(10,100,5);
