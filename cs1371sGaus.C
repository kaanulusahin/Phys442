{
  c1 = new TCanvas("c1", "Cs-137 11 second Data Gaussian Fit", 800, 600);

  h = new TH1F("h","Number of Decay Distribution(1 second)-Gaussian Fit",6,2,20);

  fgaus= new TF1("fgaus","gaus",2,20);
  fgaus->SetParameters(2,13,1);
