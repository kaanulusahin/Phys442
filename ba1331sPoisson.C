{
  c1 = new TCanvas("c1", "Ba-133 1 second Data Poisson Fit", 800, 600);

  h = new TH1F("h","Number of Decay Distribution(1 second)-Poisson Fit",7,0,14);

  fpoisson = new TF1("fpoisson","[0]*TMath::Poisson(x,[1])",0,14);
  fpoisson->SetParameters(2,6);
